...
/* 
* These functions made global to allow extended board support (bspx) initialisation functions to be interleaved
* with them in the correct order (see bspxInit()) - DK 07/09/2010
*/
void  PLL_Init         (void);
void  MAM_Init         (void);
void  GPIO_Init        (void);
